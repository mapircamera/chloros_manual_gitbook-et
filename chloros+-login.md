...
{% hint style=&quot;info&quot; %}
**SDK kasutajad**: Python SDK pakub ka programmilist `logout()` meetodit, et kustutada vahemällu salvestatud kasutajatunnused. Täpsema teabe saamiseks vaadake [Python SDK dokumentatsiooni](api-python-sdk.md#logout).
{% endhint %}
